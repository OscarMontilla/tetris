...
export const juego = {
  ...
  <div class="row">
    ...
    `,
    // Función principal del script que inicializa el juego y maneja sus acciones
script:()=>{
    ...
    // Asigna el control de las teclas
    panel.controlTeclas()
    
    // Inserta la pieza en el panel
    panel.insertarPieza()
    
    // Inicia el movimiento automático de la pieza hacia abajo
